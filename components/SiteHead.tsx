...
export const SiteHead = () => {
  ...
  return (
    <Head>
      ...
      <meta name="keywords" content="ecommerce, theme, ecommerce nextjs theme" />
      ...
      <meta property="og:description" content="ecommerce, theme, ecommerce nextjs theme" />
      ...
      <meta name="description" content="ecommerce, theme, ecommerce nextjs theme" />
